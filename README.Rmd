...
5. Download data from the GTEx portal: <https://gtexportal.org/home/>. You'll
...
6. Adjust the Makefile. Change the `nc` and `rexec` variables in the Makefile
...
7. Run `make`. To reproduce all of the results in the paper, 
...
8. Get coffee. Though most of the results will be generated rather quickly, 
